...
<?php if ($_POST['pilihan'] == 'PDF') {
    ...
    header("Content-Disposition: attachment; filename=Transaksi Menurut Periode.xls");
    $mulai = $_POST['mulai'];
    $selesai = $_POST['selesai'];
}
...
<small>Periode: <?php echo tanggal($mulai) . ' Sampai ' . tanggal($selesai); ?></small>
<hr>
<table border="1" cellpadding="2" cellspacing="0" width="100%">
    ...
    <tbody>
        ...
        $no = 1;
        $gt = 0;
        $data = mysqli_query($konektor, "SELECT * FROM transaksi,detailtransaksi WHERE transaksi.idtransaksi=detailtransaksi.idtransaksi and tanggalterima BETWEEN '$mulai' and '$selesai'");
        ...
        ?>
            <tr>
                ...
                <td align="center"><small><?php echo $d['status']; ?></small></td>
                ...
                <td align="center"><small><?php echo rupiah($d['berat'] * $d['harga']);
